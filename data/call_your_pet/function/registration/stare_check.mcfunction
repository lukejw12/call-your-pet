...
execute if entity @e[tag=cyp.target,type=#call_your_pet:has_owner,limit=1] run function call_your_pet:registration/check_owner
...
execute if entity @e[tag=cyp.target,tag=cyp.registered,limit=1] run function call_your_pet:registration/check_claimed
...
execute if score @s cyp.stare_timer matches 60 run function call_your_pet:registration/register_pet